// document.getElementById("demo").innerText = "Xin chao C0622I1";
// document.getElementById("demo").innerHTML = "<h1>Xin chao</h1>";
//getElementById có nghĩa là: in ra thành phần có Id là... thẻ con la thành phần
//innerHTML: bên trongHTML
//Trả về mã HTML bên trong phần tử hiện tại. Đoạn mã HTML này là chuỗi kí tự chứa tất cả
// phần tử bên trong, bao gồm các nút phần tử và nút văn bản.
//innerText im ra chử
//getElementById("input") để xác nhận phần tử cần sử lý
